...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('updates', url='https://t.me/Moviereview_6')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('updates', url='https://t.me/Moviereview_6'),
            InlineKeyboardButton('Group', url='https://t.me/Moviereview6')
            ],[
    ...
    if file_id.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            buttons = [
                [
                    InlineKeyboardButton('support', url='https://t.me/Moviereview_6'),
                    InlineKeyboardButton('channel', url='https://t.me/Moviereview_6')
                ],
                [
                    InlineKeyboardButton('Group', url=f'https://t.me/Moviereview6')
                ]
                ]
            try:
    ...
    buttons = [
        [
            InlineKeyboardButton('support', url='https://t.me/Moviereview_6'),
            InlineKeyboardButton('channel', url='https://t.me/Moviereview6')
        ],
        [
            InlineKeyboardButton('Group', url=f'https://t.me/Moviereview6')
        ]
